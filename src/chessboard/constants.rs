...
pub const WHITE: Color = Color::rgb(0.9098039215686274, 0.9294117647058824, 0.9764705882352941);
pub const BLUE: Color = Color::rgba(0.4823529411764706, 0.3803921568627451, 1., 0.8);
